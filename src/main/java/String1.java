...
public class String1
{
    ...
    public String extraEnd(String str) {
        ...
        String str1 = str.substring((length - 2), length);    
    ...
    public String withoutEnd(String str) {
        int middleCharacterLength = str.length() - 1;
        return str.substring(1,middleCharacterLength);
    }
    ...
    public String left2(String str) {
        ...
        String str1 = str.substring(0,2);
        if( str.length() > 2) {
            return str.substring(2,strlength) + str1;
        } else {
            return str;
        }
    ...
    public boolean hasBad(String str) {
        String str1 = "bad";
        if (str.substring(0,3).equals(str1) || str.substring(1,4).equals(str1)) {
            return true;
        } else {
            return false;
        }
    ...
    public String conCat(String a, String b) {
        ...
        int alength = a.length(); 
        if (a.substring(alength-1).equals(b.substring(0,1))) {
    ...
    public String minCat(String a, String b) {
        ...
        String str1 ;
        if ( alength > blength) {
            str1 = a.substring(a.length() - blength) + b;
            return str1;
        } else {
            str1 = a + b.substring(b.length() - alength);
            return str1;
        }
    }
    ...
    public String withoutX(String str) {
        ...
        int strlength = str.length();
        if((str.substring(0,1).equals("x")) && (str.substring(strlength-1,strlength).equals("x"))) {
            return str.substring(1,strlength-1);
        } else if(str.substring(0,1).equals("x")) {
            return str.substring(1,strlength);
        } else if(str.substring(strlength-1,strlength).equals("x")) {
    ...
    public String deFront(String str) {
        ...
        if (str.substring(0,1).equals("a")) {
            return str.substring(0,1) + str.substring(2,strlength);
        } else {
